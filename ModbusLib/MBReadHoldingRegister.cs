...
//
//  Description:
//  Implements building and interpretation of ReadHoldingRegister commands
...
namespace ModBus {
	public class MBCommandReadHoldingRegister : MBCommand {
		public MBCommandReadHoldingRegister(string sName) : base(sName) { }
		...
		public void Read() {
			...
			_QueMsg(0, MBFunctionType.enReadHoldingRegisters, pMsgData);
		}
